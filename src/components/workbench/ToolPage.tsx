...
/**
 * Server-rendered tool page. The interactive editor (Workbench) is a Client
 * Component, but all SEO content — headings, instructions, examples, FAQ, and
 * structured data — is rendered on the server for fast first paint and crawling.
 */
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_300px]">
          ...
          <aside className="space-y-6">
            ...
            <div className="card p-4 text-sm text-slate-600 dark:text-slate-400">
              ...
              <p className="mt-1">
                Every operation on this page runs locally in your browser. Your documents are never
